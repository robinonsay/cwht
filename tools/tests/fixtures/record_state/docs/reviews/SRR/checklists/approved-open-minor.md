...
checklist_file: docs/reviews/SRR/checklists/approved-open-minor.md
...
# Peer review record INSP-104 (fixture: one open Minor finding rides with APPROVED)
...
|---|---|---|---|
| finding-1 | Major | Closed | line 10 now quantified |
| finding-2 | Minor | Open | label style unchanged; fix before the next review |
