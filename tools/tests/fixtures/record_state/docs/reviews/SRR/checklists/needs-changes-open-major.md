...
checklist_file: docs/reviews/SRR/checklists/needs-changes-open-major.md
...
# Peer review record INSP-107 (fixture: an open Major finding on a NEEDS CHANGES record is not a failure)
...
|---|---|---|---|
| finding-1 | Major | Open | line 10 unchanged |
| finding-2 | Minor | Closed | label fixed |
