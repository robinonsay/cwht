...
checklist_file: docs/reviews/SRR/checklists/approved-open-count-unshown.md
...
# Peer review record INSP-103 (fixture: findings_open 1 but no open finding shown Minor)
