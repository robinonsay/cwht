# TV-003: tools/validate_docs.py (git blob 2bedc2a7, commit 28e49e6)

| Field | Value |
|---|---|
| Record | TV-003 |
| Status | **Validated** (2026-09-25; re-validated 2026-09-26 with the usage-error known answer, INSP-015 finding-5). Independent review and owner accreditation pending (sections 8 and 9) |
...
|---|---|---|---|
| `tools/validate_docs.py` | `2bedc2a7aaa14359e3adde6b50810314c9793033` | `96c9e264b99899bf5434b354c99a35514db69133dc0eda8e2294ec09e4479dc8` | equal (the file as committed in `28e49e6`) |
...
4. The `test_validate_docs.py`, `test_tools.py` and `valid_project` files used are working-tree versions; the result carries to a commit only if those files are committed unchanged (section 1 identities).
...
Proposed scope statement **ACC-VALDOCS-001**: "Accredited for purposes 1 to 5 for `tools/validate_docs.py` at git blob `2bedc2a7aaa14359e3adde6b50810314c9793033` (commit `28e49e6`), under the TV-001 interpreter with PyYAML 6.0.3."
