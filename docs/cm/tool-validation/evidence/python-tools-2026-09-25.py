"""Known-answer runs of the project Python tools for TV-002 to TV-010 (scratch procedure; transcript kept as evidence).
...
RUNS = [
  ...
  ('TV-003 validate_docs.py', ['tools/validate_docs.py'], ['tools/tests/fixtures/valid_project', 'tools/tests/fixtures/invalid_project'], [
     ('test_validate_docs.py', ['ValidProjectTests', 'InvalidProjectTests', 'PeerReviewRecordTests']),
     ('test_tools.py', [])]),
