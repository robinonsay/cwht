...
**Status: Superseded by the ADR files (2026-09-26).** The lead SE ruled on R-1 of section 7: option (A). Sections 2, 3 and 5.1, and the errata of section 6 that belong to Major findings F-01 to F-04 (E-1, E-2, E-5, E-9, E-11, E-12) with the reviewer field of E-13, are now applied in the 22 Accepted ADR files (ADR-001 to ADR-014, ADR-016 to ADR-021, ADR-024, ADR-025), each with a dated line in its new section 8 "Change log". The ADR files, not this register, are the controlling text. Hazard lines were re-derived against `docs/safety/hazards.json` 0.4.0-pha (this register used 0.3.0-pha), and the section 4.1 ids against the requirement files of 2026-09-26. Differences found in that re-check, now reflected in the ADR files: HZ-008 control K2 names ADR-012 and excludes the RD07MUS2B line-up (row V-6 is closed in the hazard record); REQ-SYS-165 no longer cites ADR-006 and REQ-SW-KEYER-014 does; REQ-SYS-122 and REQ-SYS-171 now cite ADR-014; REQ-SW-KEYER-038 cites ADR-009 and REQ-SW-KEYER-037 cites ADR-024; ADR-013 is also class 1 (c) through HZ-008 causes C7 and C8. The Minor findings (F-05 to F-08, F-10, F-11) and their errata E-3, E-4, E-6, E-7, E-8 and E-10 are not applied: under the lead SE convergence rule of 2026-09-26 (charter section 4 item 3) each is a lien, fixed before PDR. What stays open from this register: ruling R-2 (section 7, class 1 choices without a trade study), which is the owner's; the owner's approval of R-1 (A) in the SRR decision memo; and the sentence in `docs/process/05-configuration-and-data-management.md` Table 4-1 row 13 that allows this one-time correction. The rest of this file is kept unchanged as the record of the iteration 2 corrections.
...
These rulings are routed to `docs/reviews/SRR/decisions-for-owner.md` as a cross item. Until the owner rules, this register is the controlling correction of the Accepted ADRs, and the README index links it from every affected row. **Update 2026-09-26:** R-1 was ruled option (A) by the lead SE and applied to the ADR files (see the Status paragraph at the top); R-2 remains open for the owner.
