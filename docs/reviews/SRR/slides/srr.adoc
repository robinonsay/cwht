...
<div class="brow gap"><span class="bid">029</span><span class="blab">This deck: iteration 3 on revision 6 (R19)</span></div>
...
<p class="board-note">Record numbers are INSP-NNN. INSP-008 is APPROVED but fails the record drift rule after the R9 status edit until its re-issue (R17). Every Minor finding of every record is dispositioned "Lien: fix before PDR": 122 findings plus erratum E-10, carried as lien L-6.</p>
++++
...
Three NEEDS CHANGES records are held by Claude and reviewer work only: INSP-002, whose reviewer verdict is APPROVED with liens, by the open-Major heuristic of validate_docs.py that reads historical count lines as open findings (R18); INSP-029, this deck's record, by its iteration 3 on this update; and INSP-030, whose readiness R3 the 05 self-check at 8ef95d3 answers (R19).
...
| [.nw]##L-6## | Every Minor finding of the 30 records: 122 findings plus erratum E-10, "fix before PDR" | Each record's owner | PDR readiness declaration
...
L-6 is new in revision 4: under the lead SE convergence rule, every Minor finding of every record, 122 findings in revision 6 and the INSP-011 erratum E-10, is a lien to fix before PDR, and the reviewer of the owning record verifies each fix at its next iteration; five findings were Verified at the re-issues and seven are new, four of them in INSP-030.
...
* *At the gate review:* the request is *Approved with liens* L-1 to L-7 (L-6 is the 122 record liens)
