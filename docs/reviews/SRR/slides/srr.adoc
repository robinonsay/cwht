= SRR pre-review session: cwht, SRR combined with MCR, package revision 6
...
Package `docs/reviews/SRR/package.md`, revision 6 of [.nw]##2026-09-26##, written at HEAD [.nw]##`5f647f2`##, where every cited product and record is committed; revision 6 is committed at [.nw]##`30a6905`##. Revision 5, with the records and the previous deck, is at [.nw]##`d4cce27`##.

Chair, Decision Authority, ETA and SMA TA: Robin. Presenter: Claude (lead systems engineer).

[.callout.warn]
Pre-review session: the SRR gate review is not convened. The readiness declaration cannot be made: Hard rows S3 and 20 are Not met, S1 awaits your confirmation, and 12 Hard rows are Partially met (package section 4).
...
Package revision 6 of 2026-09-26 was written against HEAD 5f647f2: every product and record it cites is committed there, and 28 of the 30 review records name the committed file versions; the revision itself is committed at 30a6905 as a routine CM record.
Revision 6 records the Claude and reviewer work since revision 5: the paired assurance record INSP-030, the 16 author self-checks, 17 record re-issues and the three hazard status edits; 24 of the 30 records are now APPROVED.
The gate review is not convened, because Hard rows S3 and 20 are Not met, S1 waits for your confirmation and 12 Hard rows are Partially met.
...
This deck is the revision 5 deck of d4cce27 updated for revision 6 under item R19; its record INSP-029 verifies the update at iteration 3.
...
* *Readiness:* not declarable at revision 6; the goal state, in which only your items remain, is not yet reached: R17 to R19, then R15
* *Tools:* at [.nw]##`5f647f2`## `validate_docs.py` and 1 of 392 tool tests fail on one cause, the [.nw]##INSP-008## drift (R17); every other gate tool exits 0; developer evidence until accreditation (K15)
...
Revision 6 re-reads the readiness items, the remaining work and the entrance rows from the 30 records and the products at HEAD 5f647f2, after the paired 05 assurance record, the 16 author self-checks, 17 record re-issues and the three hazard status edits of items R6 to R9.
Two gate tools exit 1 on one cause: the R9 status edit changed the two hazard files that the APPROVED record INSP-008 names, so validate_docs reports 48 passed and 1 failed and the tool suite passes 391 of 392 tests; traceability PASS with 0 violations and 3 warnings, the risk check with the hazard cross-check and the RMM and compliance checks exit 0. No product or record content is wrong.
The goal state, in which only your rulings, OA-1, OA-2 and your readiness confirmation remain, is still not reached: the INSP-008 delta re-issue (R17), the validator heuristic that holds INSP-002 (R18), this deck's update with the INSP-029 and INSP-030 re-issues (R19) and then the repeat readiness review (R15) are Claude and reviewer work.
...
<div class="brow gap"><span class="bid">H1</span><span class="blab">Records: 5 open Major on rulings; <span class="nw">INSP-008</span> (R17), 002 (R18), 029, 030 (R19)</span></div>
<div class="brow gap"><span class="bid">H3</span><span class="blab">This deck: revision 6 update; <span class="nw">INSP-029</span> iteration 3 (R19)</span></div>
...
<div class="brow gap"><span class="bid">H17</span><span class="blab">28 of 30 records on the blobs; <span class="nw">INSP-008</span> (R17), 029 (R19)</span></div>
</div>
...
[.notes]
--
Revision 2 listed 17 Hard shortfalls and items due before the declaration; revision 6 re-rates each one against the 30 records and the products at 5f647f2.
Eight are open; H1 is the largest: 5 open Major findings in three records, each closing only on your ruling, then four record actions that need no ruling: the INSP-008 delta re-issue after the hazard status edit (R17), INSP-002 held by a validator heuristic (R18), and this deck's record INSP-029 and the 05 assurance record INSP-030 (R19).
H5, H14 and H15 now stand only on your rulings: INSP-013, the 07 records INSP-010 and INSP-018 and the row 25 records INSP-004 and INSP-026 are APPROVED with liens; H7 has nine SRR-due hazard questions open, eight on your rulings, and OQ-SAF-007, 025 and 026 are Closed by the R9 edit.
...
| Records, tools | R17 [.nw]##INSP-008## delta re-issue; R18 `validate_docs.py` heuristic, then [.nw]##INSP-002## re-issue; R19 this deck, [.nw]##INSP-029## iteration 3, [.nw]##INSP-030## re-issue | Claude; reviewers | Open
| Last step | R15 repeat readiness review | Reviewer | After R17 to R19
...
| Done | R3 to R5; R6 [.nw]##INSP-030##; R7 16 self-checks; R8 17 re-issues; R9 hazard statuses; R10 to R14 | | Done
|===

[.notes]
--
Package section 2.1 is the complete list, R1 to R19, grouped here by owner.
...
R6 to R9 are done: INSP-030 is filed, the 16 author self-checks are filed, 17 records are re-issued and OQ-SAF-007, 025 and 026 are Closed.
The Claude and reviewer part that still depends on no ruling is R17 to R19 and then R15; R17 and R18 were exposed by R8 and R9 themselves. When they are done, the only open items that do not wait on a ruling are yours.
...
Commits of work products are routine CM records that I make under the CM plan, not an owner action; revision 6 is committed at 30a6905 and this deck update by its own commit; OA-8 covers only the gate disposition and the baseline tag.
Evidence: package section 2.1 items R1 to R19 and the goal-state paragraph; section 2.2 OA-8.
Question for Robin: none on this slide; R17 to R19 need no ruling.
--

== Review records: 30 records at revision 6 [.src]#§2.4, §3#

++++
<div class="board">
<div class="lane ok"><div class="lane-head"><span>APPROVED</span><span>24</span></div>
...
<div class="brow"><span class="bid">008</span><span class="blab">Hazards: drift, R17</span></div>
...
<div class="lane nt"><div class="lane-head"><span>Re-issue, no ruling</span><span>3</span></div>
<div class="brow gap"><span class="bid">002</span><span class="blab">ConOps, concept: validator heuristic (R18)</span></div>
<div class="brow gap"><span class="bid">029</span><span class="blab">This deck: iteration 3 done, re-issue (R19)</span></div>
<div class="brow gap"><span class="bid">030</span><span class="blab">05 assurance: readiness R3 answered (R19)</span></div>
</div>
...
<p class="board-note">Record numbers are INSP-NNN. INSP-008 is APPROVED but fails the record drift rule after the R9 status edit until its re-issue (R17). Every Minor finding of every record is dispositioned "Lien: fix before PDR": 120 findings plus erratum E-10, carried as lien L-6.</p>
++++

[.notes]
--
All 30 records are filed as their front matter reads: 24 APPROVED and 6 NEEDS CHANGES.
Since revision 5 the 16 author self-checks were filed and 17 records re-issued without a further product review; 14 moved to APPROVED, among them INSP-004 and INSP-013 on their paired assurance records INSP-026 and INSP-027, and INSP-006 with the new paired record INSP-030.
Three NEEDS CHANGES records are held by Claude and reviewer work only: INSP-002, whose reviewer verdict is APPROVED with liens, by the open-Major heuristic of validate_docs.py that reads historical count lines as open findings (R18); INSP-029, this deck's record, whose iteration 3 found no new finding and Verified finding-2 and finding-4, held by readiness R1 (the INSP-008 drift) until its re-issue; and INSP-030, whose readiness R3 the 05 self-check at 8ef95d3 answers (R19).
...
INSP-008 stays APPROVED, but the R9 status edit changed the hazard files it names, so the validator fails it until its reviewer verifies that status-only delta and re-issues it (R17).
...
* Blob check at [.nw]##`5f647f2`##: 28 of 30 records name exactly the committed blobs; candidate item 57 (Major) stays Closed
* Two drifts: [.nw]##INSP-008## (APPROVED; hazard files changed by the R9 status edit at [.nw]##`ade0e09`##; validator FAIL until R17) and [.nw]##INSP-029## (this deck; iteration 3 on this update, R19)
...
The product-blob check compared every product file a record lists with git rev-parse HEAD:<path>: the revision 5 drifts of INSP-003 and INSP-004 closed at their re-issue at 5f647f2, and the two drifts left, INSP-008 and INSP-029, are items R17 and R19 and hide no content change.
Evidence: package sections 2.3 and 2.4; section 15 items 27, 46, 52, 53, 57 and 67; docs/reviews/SRR/checklists/requirements-sys.md, adrs-001-to-025.md, fw-b0-toolchain-proof.md.
Question for Robin: none here; you rule these through K10, K11, K12 and K16.
--

== Entrance-criteria checklist [.src]#§4, §7#

image::../figures/entrance-checklist.png[alt="Entrance criteria board: Not met 4, Partially met 13, Met 22",width=1760]

[.notes]
--
The board shows all 39 entrance criteria, the eleven standing criteria S1 to S11 and the 28 SRR rows, under the single rating rule of package section 4: Met 22, Partially met 13, Not met 4.
Revision 6 re-rated rows 1, 2 and 3 Met, because INSP-001 is APPROVED on the committed blobs and no ruling holds their content; revision 5 had re-rated S11 Partially met, and its count line of 15 and 5 was corrected to the 16 and 4 of its table (candidate item 70).
The Hard rows not Met each block the declaration: S1 waits for you, S3 and 20 are Not met, and 12 Hard rows are Partially met.
Of the Partially met rows, 7, 8, 15, 22, 23 and 25 wait on your rulings only; 5 on rulings for the ADR part; 14 on rulings plus the INSP-008 re-issue (R17); 4 and 10 on the INSP-002 re-issue (R18), row 10 also on decisions 36 and 37; 12 and S11 on R19.
...
Evidence: package section 4 table and counts line; figure docs/reviews/SRR/figures/entrance-checklist.png, generated by tools/render_review_figures.py (blob 6f3018fd) from revision 6 and opened 2026-09-26 (package section 7).
Question for Robin: none on this slide.
--
...
| ConOps and concept ([.nw]##SE-36##) `docs/conops/`, `concept.md` | 9 modes, 22 scenarios, B01 to B22, 10 descopes | [.nw]##INSP-002##: validator heuristic (R18)
...
| Hazards, risks `docs/safety/`, `docs/risk/` | 15 hazards, 118 controls; 65 risks (Red 32) | [.nw]##INSP-008## (R17), [.nw]##INSP-007##: APPROVED
| SEMP ([.nw]##SE-38##, [.nw]##SE-66##), plans 01 to 08, RMM, matrix | 100 RMM rows; 62 compliance rows | All APPROVED; [.nw]##INSP-030## re-issue (R19)
...
Every plan record is APPROVED with liens after the re-issues of 2026-09-26, the CM plan 05 with its new paired assurance record INSP-030, whose assurance verdict is APPROVED and whose own record re-issue is item R19.
...
Entrance row 10 is Partially met: INSP-002 meets readiness and its reviewer verdict is APPROVED with liens finding-19 to 22, but the open-Major heuristic of validate_docs.py holds its record verdict until item R18.
...
* Report re-run [.nw]##2026-09-26## at [.nw]##`5f647f2`##, byte-identical: PASS, 0 violations, 3 warnings; 238 requirements, 170 cases, all Draft
...
[.notes]
--
The frozen traceability report, re-run for revision 6 at 5f647f2 and byte-identical to the committed copy, passes with no violations and three warnings.
...
[.notes]
--
The hazard analysis at 0.4.3-pha has fifteen hazards, unchanged in severity, likelihood and residual since 0.4.0-pha; INSP-008 is APPROVED with liens finding-14 to 16 on 0.4.2-pha, and its reviewer verifies the status-only 0.4.3-pha delta and re-issues it (R17).
...
| SRR package ready | [.nw]##2026-09-26## morning | Revision 6 assembled; not ready (section 2.1) | This session for rulings and [.nw]##OA-1##; R17 to R19 re-issues and deck; repeat readiness review
...
The SRR milestone is not met: revision 6 is assembled and committed, but the owner items R1 and R2, the Claude and reviewer items R17 to R19 and R15, and then R16 remain.
The recovery is this session for your rulings and OA-1, then the INSP-008 delta re-issue, the validator fix with the INSP-002 re-issue, this deck's record and the INSP-030 re-issue, and the repeat readiness review.
...
| Major, Closed | 5, 9, 26, 28, 44, 50, 51, 57, 62, 63, 69 | none (69 in revision 6)
| Major, carried by R items before the declaration | 61, 67, 68 | R15, R17 to R19
| Minor, Closed | 1, 4, 6, 12 to 22, 24, 30 to 33, 35, 36, 39, 56, 59, 64, 65, 70 | none
...
Package section 15 offers 71 candidate items, items 61 to 66 being the findings of the independent readiness review of revision 4 and items 67 to 71 those found at the assembly of revision 6; none is a RID until you adopt it, and this slide accounts for every one of them by its handling.
The four open Major items are the five open Major findings of slide 8; three Major items are carried by the remaining Claude and reviewer work: item 61, the readiness finding F-01, and items 67 and 68, the INSP-008 drift and the validator heuristic, closed by R17 to R19 and verified by R15; every other Major item is Closed, including item 69, the consent re-check that moved decisions 42, 73 and 74.
Every Minor item is either Closed or a lien to fix before PDR under the convergence rule: the record liens are L-6 and the package-level items L-4, now with item 71, the stale default of decision 94; item 58, the mislabelled revision on an earlier deck, is corrected by this deck.
...
| 079, 081 | CM plan 05 and CI list | [.met]#Done#: [.nw]##INSP-006## APPROVED with [.nw]##INSP-030## (re-issue, R19)
...
The paired assurance review of the CM plan 05 is now filed: INSP-030, 0 Major, assurance verdict APPROVED with liens finding-1 to 4; its record verdict waits only on its re-issue (R19), and decision 118 needs no ruling.
The FW-B0 proof is Blocked at run 2 until your rulings K9 and K10, OA-1 and the post-ruling work R16; firmware metrics are 10 of 10 host tests and 100 percent line and region coverage of the host crates as developer evidence, the tool suite passes 391 of 392 until R17, and no nonconformance is open.
...
<div class="lane pm"><div class="lane-head"><span>Partially met</span><span>5</span></div>
...
<div class="lane ok"><div class="lane-head"><span>Met</span><span>9</span></div>
...
Revision 6 re-rated C2 Met, because the compliance matrix record INSP-024 is APPROVED with seven liens at 119cb36; revision 4 re-rated 4.4-4, 4.4-6, 4.4-9, 4.4-10, C4 and C6 Met, because their records are APPROVED with liens and what remained was an approval the gate itself grants.
...
Five are Partially met, mostly for pending rulings, and 4.4-7 for the INSP-002 re-issue (R18); 4.4-11 stays Partially met on decisions 38 to 40.
...
| [.nw]##L-4## | Package-level Minor items 2, 3, 8, 11, 38, 55, 58, 71 and the open Minor ConOps D items | Claude or author | PDR readiness declaration
...
| [.nw]##L-6## | Every Minor finding of the 30 records: 120 findings plus erratum E-10, "fix before PDR" | Each record's owner | PDR readiness declaration
...
L-6 is new in revision 4: under the lead SE convergence rule, every Minor finding of every record, 120 findings in revision 7 and the INSP-011 erratum E-10, is a lien to fix before PDR, and the reviewer of the owning record verifies each fix at its next iteration; since revision 5, seven findings were Verified (five at the re-issues, finding-2 and finding-4 of INSP-029 at its iteration 3) and seven are new, four of them in INSP-030.
...
* *Then (Claude and reviewers):* R17 to R19 and R15; after your rulings, R16
...
After the session, the reviewers and I finish R17 to R19 and R15, and the post-ruling work R16, which Hard rows 14, 15 and 20 close through; then you confirm readiness and I present the gate review.
