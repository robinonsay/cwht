= SRR pre-review session: cwht, SRR combined with MCR, package revision 8
...
Package `docs/reviews/SRR/package.md`, revision 8 of [.nw]##2026-09-26##, written at HEAD [.nw]##`b4abcc5`##, where every cited product and record is committed; revision 8 is committed on top of it. Revision 7 is at [.nw]##`8d7eca7`##; revision 6 at [.nw]##`30a6905`##.

Chair, Decision Authority, ETA and SMA TA: Robin. Presenter: Claude (lead systems engineer).

[.callout.warn]
Pre-review session: the SRR gate review is not convened. The readiness declaration cannot be made: Hard rows S3 and 20 are Not met, S1 awaits your confirmation, and 10 Hard rows are Partially met (package section 4).
...
Package revision 8 of 2026-09-26 was written against HEAD b4abcc5: every product and record it cites is committed there, and 29 of the 30 review records name the committed file versions; the revision itself is committed on top of b4abcc5 as a routine CM record, and it changes no product.
Revision 8 is a status update: items R17 and R18 and the INSP-030 part of R19 (b) are done, which closes readiness findings R15-F1 to R15-F3; 26 of the 30 records are now APPROVED and every gate tool exits 0.
The gate review is not convened, because Hard rows S3 and 20 are Not met, S1 waits for your confirmation and 10 Hard rows are Partially met.
...
This deck is the revision 6 deck of ef6472a with the revision 7 count edit, updated where revision 8 changed a claim; its record INSP-029 reviewed the revision 6 deck at iteration 3, and its re-issue is pending.
...
* *Readiness:* not declarable at revision 8; the goal state, in which only your items remain, is not yet reached: the [.nw]##INSP-029## re-issue, then R15
* *Tools:* at [.nw]##`b4abcc5`## every gate tool exits 0: `validate_docs.py` 49 passed, 400 of 400 tool tests; developer evidence until accreditation (K15)
...
Revision 8 re-reads the readiness items, the remaining work and the entrance rows from the 30 records at HEAD b4abcc5, after the INSP-008 re-issue on the 0.4.3-pha hazard blobs (R17), the record state rule of validate_docs.py with the INSP-002 and INSP-015 re-issues (R18) and the INSP-030 re-issue (R19 (b)).
Every gate tool exits 0: validate_docs reports 49 passed and 0 failed, the tool suite passes 400 of 400 tests, traceability PASS with 0 violations and 3 warnings, and the risk check with the hazard cross-check and the RMM and compliance checks exit 0. No product or record content is wrong.
The goal state, in which only your rulings, OA-1, OA-2 and your readiness confirmation remain, is still not reached: the INSP-029 re-issue (R19 (b)) and then the repeat readiness review (R15) are Claude and reviewer work.
...
<div class="brow gap"><span class="bid">H1</span><span class="blab">Records: 5 open Major on rulings; <span class="nw">INSP-029</span> re-issue (R19)</span></div>
<div class="brow gap"><span class="bid">H3</span><span class="blab">This deck: <span class="nw">INSP-029</span> re-issue only (R19)</span></div>
...
<div class="brow gap"><span class="bid">H17</span><span class="blab">29 of 30 records on the blobs; <span class="nw">INSP-029</span> (R19)</span></div>
</div>
...
[.notes]
--
Revision 2 listed 17 Hard shortfalls and items due before the declaration; revision 8 re-rates each one against the 30 records and the products at b4abcc5.
Eight are open; H1 is the largest: 5 open Major findings in three records, each closing only on your ruling, then one record action that needs no ruling, the re-issue of this deck's record INSP-029 (R19 (b)); R17, R18 and the INSP-030 re-issue are done.
H3 and H17 are open on that same INSP-029 re-issue only: it verifies the revision 7 count edit of slides 7, 40 and 42, the one drift of the blob check.
...
| Records | R19 (b): [.nw]##INSP-029## re-issue, verifying the revision 7 count edit | Reviewer | Pending
| Last step | R15 repeat readiness review | Reviewer | After R19 (b)
...
| Done | R3 to R14; R17 [.nw]##INSP-008##; R18 record state rule, [.nw]##INSP-002##, [.nw]##INSP-015##; R19 (a) deck; R19 (b) [.nw]##INSP-030## | | Done
|===
...
R17 and R18 are done since revision 7: INSP-008 verified the hazard status edit and was re-issued at 2aaad2a; the record state rule of validate_docs.py at 96af250 replaced the line heuristic, INSP-002 was re-issued APPROVED at b08e55d and INSP-015 verified the tool delta at b4abcc5 with two new liens, F-08 and F-09. INSP-030 was re-issued APPROVED at 99ecccb. Together they close readiness findings R15-F1 to R15-F3.
The Claude and reviewer part that still depends on no ruling is the INSP-029 re-issue and then the repeat readiness review R15. When they are done, the only open items that do not wait on a ruling are yours.
...
Commits of work products are routine CM records that I make under the CM plan, not an owner action; revision 8 is committed on top of b4abcc5 and this deck update by its own commit; OA-8 covers only the gate disposition and the baseline tag.
Evidence: package section 2.1 items R1 to R19 and the goal-state paragraph; section 2.2 OA-8.
Question for Robin: none on this slide; the INSP-029 re-issue and R15 need no ruling.
--

== Review records: 30 records at revision 8 [.src]#§2.4, §3#

++++
<div class="board">
<div class="lane ok"><div class="lane-head"><span>APPROVED</span><span>26</span></div>
...
<div class="lane nt"><div class="lane-head"><span>Re-issue, no ruling</span><span>1</span></div>
<div class="brow gap"><span class="bid">029</span><span class="blab">This deck: iteration 3 done, re-issue pending (R19)</span></div>
</div>
...
<p class="board-note">Record numbers are INSP-NNN. No APPROVED record fails a gate tool. Every Minor finding of every record is dispositioned "Lien: fix before PDR": 122 findings plus erratum E-10, carried as lien L-6.</p>
++++

[.notes]
--
All 30 records are filed as their front matter reads: 26 APPROVED and 4 NEEDS CHANGES.
Since revision 7 INSP-008 was re-issued on the 0.4.3-pha hazard blobs (R17); INSP-002 moved to APPROVED after the record state rule of validate_docs.py replaced the line heuristic (R18); INSP-015 verified that tool delta and was re-issued APPROVED with two new liens, F-08 and F-09; and INSP-030 moved to APPROVED on the 05 self-check at 8ef95d3 (R19 (b)).
One NEEDS CHANGES record is held by reviewer work only: INSP-029, this deck's record, whose iteration 3 found no new finding and Verified finding-2 and finding-4; its readiness R1 closed with R17, and its re-issue, which verifies the revision 7 count edit, is pending. It is that record's third NEEDS CHANGES, so I raise it with you here; no product change was required.
...
The record liens move from 120 to 122 with INSP-015 F-08 and F-09.
...
* Blob check at [.nw]##`b4abcc5`##: 29 of 30 records name exactly the committed blobs; candidate item 57 (Major) stays Closed
* One drift: [.nw]##INSP-029## (NEEDS CHANGES; the revision 7 count edit of slides 7, 40, 42), verified by its re-issue (R19 (b)); `validate_docs.py` exit 0
...
The product-blob check compared every product file a record lists with git rev-parse HEAD:<path> at b4abcc5: the INSP-008 drift closed with its re-issue at 2aaad2a (R17), INSP-015 names the HEAD blobs of all 43 files it lists since b4abcc5, and the one drift left, INSP-029 on the revision 7 count edit, is item R19 (b) and hides no content change.
...
Revision 8 re-rated rows 4 and 12 Met, because INSP-002 is APPROVED at b08e55d and INSP-030 at 99ecccb and no ruling holds their content; revision 6 had re-rated rows 1, 2 and 3 Met on INSP-001.
The Hard rows not Met each block the declaration: S1 waits for you, S3 and 20 are Not met, and 10 Hard rows are Partially met.
Of the Partially met rows, 7, 8, 15, 22, 23 and 25 wait on your rulings only; 5 on rulings for the ADR part; 14 on rulings and the post-ruling OPS-013 edit (R16); 10 on decisions 36, 37, 41 and 42 and the post-ruling ConOps edit (R16); S11 on the INSP-029 re-issue; S3 on the rulings and the INSP-029 re-issue; row 20 on rulings, OA-1 and R16.
...
Evidence: package section 4 table and counts line; figure docs/reviews/SRR/figures/entrance-checklist.png, generated by tools/render_review_figures.py (blob 6f3018fd) from revision 8 and opened 2026-09-26 (package section 7).
Question for Robin: none on this slide.
--
...
| SRR package ready | [.nw]##2026-09-26## morning | Revision 8 assembled; not ready (section 2.1) | This session for rulings and [.nw]##OA-1##; [.nw]##INSP-029## re-issue; repeat readiness review
...
The SRR milestone is not met: revision 8 is assembled and committed, but the owner items R1 and R2, the INSP-029 re-issue of R19 (b) and the repeat readiness review R15, and then R16 remain.
The recovery is this session for your rulings and OA-1, then the INSP-029 re-issue and the repeat readiness review.
...
| Major, Closed | 5, 9, 26, 28, 44, 50, 51, 57, 62, 63, 67 to 69, 72 to 74 | none (67, 68, 72 to 74 in revision 8)
| Major, carried by R items before the declaration | 61, 75 | R19 (b) [.nw]##INSP-029## re-issue; R15
...
Package section 15 offers 75 candidate items, items 61 to 66 being the findings of the independent readiness review of revision 4, items 67 to 71 those found at the assembly of revision 6, and items 72 to 75 the findings R15-F1 to R15-F4 of the repeat readiness review of revision 6; none is a RID until you adopt it, and this slide accounts for every one of them by its handling.
The four open Major items are the five open Major findings of slide 8; two Major items are carried by the remaining reviewer work: item 61, the readiness finding F-01, and the open part of item 75, both by the INSP-029 re-issue and the repeat of R15; every other Major item is Closed, including items 67 and 72, closed by R17, items 68 and 73 by R18, item 74 by the INSP-030 re-issue, and item 69, the consent re-check that moved decisions 42, 73 and 74.
...
L-6 is new in revision 4: under the lead SE convergence rule, every Minor finding of every record, 122 findings in revision 8 and the INSP-011 erratum E-10, is a lien to fix before PDR, and the reviewer of the owning record verifies each fix at its next iteration; revision 8 adds INSP-015 F-08 and F-09 from the delta verification of the record state rule, which moves the count from 120 to 122.
...
* *Then (reviewers):* the [.nw]##INSP-029## re-issue and R15; after your rulings, R16 (Claude and reviewers)
...
After the session, the reviewers finish the INSP-029 re-issue and the repeat readiness review R15, and the reviewers and I do the post-ruling work R16, which Hard rows 14, 15 and 20 close through; then you confirm readiness and I present the gate review.
