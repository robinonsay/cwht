...
iteration: 1
# readiness_met: false because R3 (author self-check against sections A to G) is not on record for 08 or README; see Readiness
readiness_met: false
# reviewer_verdict: no Major finding; every Minor finding is "Lien: fix before PDR" (convergence rule of 2026-09-26)
# verdict: held at NEEDS CHANGES only by readiness R3 (not a finding), as in INSP-006 and INSP-010 at iteration 3;
