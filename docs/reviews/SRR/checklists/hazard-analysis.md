...
# product_commit: base commit (last commit touching docs/safety/); the reviewed content is the
# working-tree blobs in product_files (package item H17: products not yet committed).
# product_files: blobs re-reviewed at iteration 2 (0.4.0-pha); iteration 1 blobs are in the body table
product_commit: "28e49e6"
product_files: ["docs/safety/hazard-analysis.md@c20281a7d6cf64f38d678537de895ca7908fc11f", "docs/safety/hazards.json@89d0cbc323b2775d326cf7cd42bc637818ec96eb"]
data_file: docs/safety/hazards.json
data_file_version: 0.4.0-pha
...
# finding-14 and finding-15 are new at iteration 2
findings_major: 3
findings_minor: 12
findings_open: 3
findings_fixed: 0
...
deferred_rids: []
# iteration 2 answers (iteration 1: R1, R2, CK-SAF-A7, C2, C4, C5, C6, D2, D3, D5, F1, F3, G1, G2, G3, G5)
items_no: [R1, CK-SAF-D5, CK-SAF-G1]
effort_turns: 74
effort_minutes: 90
record_status: Open
date: 2026-09-25
...
Open Major: 0. Open Minor: 3. finding-5 and finding-6 are closed for this product (requirement ids named in section 8.1; the rationale corrections routed in section 11.2 and OQ-SAF-025); the stale rationales themselves remain in `docs/requirements/sys/requirements.json` and are counted once, under finding-8.
